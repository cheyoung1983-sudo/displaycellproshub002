...
const NICHE_PRESETS: NichePreset[] = [
  ...
  {
    id: 'leather',
    name: 'Minimalist Leather Goods & Accessories',
    tagline: 'Handcrafted full-grain leather everyday carry essentials',
    ...
    testimonials: [
      {
        ...
        rating: 5,
        productPurchased: 'Heritage Full-Grain Leather Weekender',
        content: 'The vegetable-tanned Tuscan leather has developed the most gorgeous rich honey patina after 6 months of heavy travel. The saddle stitching is indestructible and the solid brass hardware feels heirloom grade.',
        date: '3 days ago',
        verifiedBuyer: true,
        helpfulCount: 35,
        avatarColor: 'from-amber-700 to-stone-800'
      },
      {
        id: 'le-2',
        user: 'Sienna Laurent',
        location: 'Austin, TX',
        rating: 5,
        productPurchased: 'Slim Bifold Cardholder Wallet',
        content: 'Holds 8 cards and folded banknotes effortlessly without creating awkward pocket bulk. The hand-burnished edge finish is silky smooth. Worth every single penny.',
        date: '1 week ago',
        verifiedBuyer: true,
        helpfulCount: 22,
        avatarColor: 'from-rose-600 to-stone-700'
      },
      {
        id: 'le-3',
        ...
        location: 'Chicago, IL',
        rating: 5,
        productPurchased: 'Architect Laptop Folio 16"',
        content: 'Snug, protective fit for my MacBook with dedicated slots for stylus and magnetic charger. The unlined suede interior prevents any surface scratching. Truly exceptional craftsmanship.',
        date: '2 weeks ago',
        verifiedBuyer: true,
        helpfulCount: 17,
        avatarColor: 'from-yellow-700 to-amber-900'
      },
      {
        id: 'le-4',
        user: 'Morgan Vance',
        ...
        rating: 5,
        productPurchased: 'Braided Key Lanyard & Valet Tray Set',
        content: 'The leather smells incredible right out of the custom linen gift box. Makes an impeccable gift for anyone who appreciates thoughtful minimalist design.',
        date: '1 month ago',
        verifiedBuyer: true,
        helpfulCount: 9,
  ...
  {
    id: 'coffee',
    name: 'Artisan Specialty Coffee Roastery',
    tagline: 'Single-origin micro-lots roasted fresh to order',
    badge: 'Specialty Beverage',
    testimonials: [
      {
        id: 'cf-1',
        user: 'Matteo Rossi',
        location: 'Denver, CO',
        rating: 5,
        productPurchased: 'Ethiopian Yirgacheffe (Natural Process)',
        content: 'Vibrant jasmine floral aromatics with juicy blueberry and bergamot acidity. Roasted within 48 hours of dispatch; the crema extraction on my E61 espresso machine is the best I have ever pulled.',
        date: 'Yesterday',
        verifiedBuyer: true,
        helpfulCount: 47,
      ...
      {
        id: 'cf-2',
        user: 'Hannah Lindqvist',
        location: 'Seattle, WA',
        rating: 5,
        productPurchased: 'High-Elevation Colombian Gesha Lot #4',
        content: 'Silky mouthfeel with delicate notes of white peach and clover honey. The tasting notes on the bag are extraordinarily accurate. Subscribed for bi-weekly delivery immediately.',
        date: '4 days ago',
        verifiedBuyer: true,
        helpfulCount: 31,
      ...
      },
      {
        ...
        rating: 5,
        productPurchased: 'Barista Precision Flat-Bottom Dripper Set',
        content: 'Even water flow and zero bypass clogging. Unlocked sweetness and clarity in light roasts that my old conical dripper could never achieve. Highly recommended.',
        date: '2 weeks ago',
        verifiedBuyer: true,
        helpfulCount: 16,
      ...
      },
      {
        ...
        rating: 5,
        productPurchased: 'Midnight Espresso Roast Blend',
        content: 'Deep dark chocolate notes without any burnt bitterness. Cuts through oat milk perfectly for morning flat whites. Customer support is wonderfully attentive.',
        date: '3 weeks ago',
        verifiedBuyer: true,
        helpfulCount: 12,
        avatarColor: 'from-yellow-800 to-stone-900'
      }
    ]
  },
  {
    id: 'skincare',
    name: 'Organic Clean Skincare & Serums',
    tagline: 'Dermatologist-formulated botanical actives & barrier restoration',
    badge: 'Clean Beauty',
    testimonials: [
      {
        id: 'sk-1',
        user: 'Camilla Sterling',
        location: 'Miami, FL',
        rating: 5,
        productPurchased: 'Botanical Vitamin C + Ferulic Radiance Serum',
        content: 'Faded stubborn sun spots in three weeks without any stinging or redness. The texture sinks in instantly without sticky residue and sits gorgeously under makeup all day.',
        date: '2 days ago',
        verifiedBuyer: true,
        helpfulCount: 39,
      ...
      },
      {
        ...
        location: 'Toronto, ON',
        rating: 5,
        productPurchased: 'Ceramide Barrier Recovery Night Elixir',
        content: 'Completely rescued my compromised moisture barrier after harsh winter winds. Woke up with calm, plump, deeply hydrated skin. A permanent staple on my vanity.',
        date: '6 days ago',
        verifiedBuyer: true,
        helpfulCount: 26,
      ...
      },
      {
        ...
        rating: 5,
        productPurchased: 'Invisible Zinc Mineral SPF 50 Shield',
        content: 'Zero white cast, non-comedogenic, and matte finish without drying out my t-zone. Finding a clean mineral sunscreen this elegant is rare. 10/10.',
        date: '1 week ago',
        verifiedBuyer: true,
        helpfulCount: 21,
      ...
      {
        id: 'sk-4',
        user: 'Zoe Kravitz-Lee',
        location: 'San Diego, CA',
        rating: 5,
        productPurchased: 'Hydra-Plump Multi-Molecular Hyaluronic Acid',
        content: 'Immediate glass-skin hydration boost. The amber glass bottle with measured pipette packaging keeps the active ingredients fresh. Exceptional quality.',
        date: '3 weeks ago',
        verifiedBuyer: true,
        helpfulCount: 15,
